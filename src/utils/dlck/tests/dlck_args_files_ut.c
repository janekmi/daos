...
static const struct CMUnitTest tests_all[] = {
    ...
    {"ARGFILES103: parser ARGP_KEY_END no files", test_parser_KEY_END_without_files_fails, setup,
     NULL},
    {"ARGFILES104: parser ARGP_KEY_END success", test_parser_KEY_END_with_files_success, setup,
     NULL},
    ...
    {"ARGFILES112: dlck_args_files_free() multiple files", test_files_free_three_files, setup,
     NULL},
};
