...
static struct dlck_file *create_dummy_file(const char *uuid_str)
{
...
static void test_args_files_check_should_fail_if_no_files(void **state)
{
    struct dlck_args_files *args = *state;
...
static void test_args_files_parser_should_add_file_to_list(void **state)
{
    struct dlck_args_files *args = *state;
...
static void test_dlck_args_files_free_should_cleanup_list(void **state)
{
    struct dlck_args_files *args = *state;
...
int main(void)
{
    const struct CMUnitTest tests[] = {
        cmocka_unit_test_setup_teardown(test_args_files_init_should_initialize_list, setup, teardown),
        cmocka_unit_test_setup_teardown(test_args_files_check_should_fail_if_no_files, setup, teardown),
        cmocka_unit_test_setup_teardown(test_args_files_parser_should_add_file_to_list, setup, teardown),
