...
/**
 * Report targets' progress.
 *
 * \note It does the thing only when the main output stream is a terminal.
 *
 * \param[in]	progress	Array of progress for all targets.
 * \param[in]	progress_max	Total work planned.
